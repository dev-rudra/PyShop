...
**Make Migrations** it to the database run following command:
...
```
After the `makemigrations` we need to `migrate` with the following command:

`python3 manage.py migrate`

We will see the following reslut
